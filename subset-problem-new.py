...
class SSP():
    ...
    def random_yes_instance(self, n, bitlength=8):
        max_n_bit_number = 2**bitlength-1
    ...
    def sim_anneal(self):
        ...
        while Temp > TempMin:
            ...
            while i <= 3:
                ...
                #print("Initial Solution: " +str(solution) + " oldCost: " + str(old_cost))
                new_cost = self.CalculateCost(solution1)
                
                #print("Neighbouring Solution: " +str(solution1)  + " newCost: " + str(new_cost))
                if self.t-new_cost==0:
                    return self.t - new_cost
                if self.t-old_cost>self.t-new_cost and new_cost<self.t:
                        old_cost = new_cost
                if self.t-old_cost==0:
                    return self.t - old_cost
